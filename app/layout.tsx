    ...
    <html lang="en">
      <body className={inter.className}>
        <div className="h-full w-full absolute">
          <div id="mobile-nav" className="w-full xl:hidden h-full absolute z-40">
            <div className="bg-gray-800 opacity-50 inset-0 fixed w-full h-full"></div>
              ...
              <div className="flex flex-col justify-between h-full">
                <div className="px-6 pt-4 overflow-y-auto">
                  <div className="flex items-center justify-between">
                    ...
                    <button id="cross" className="hidden text-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 rounded">
                      <svg aria-label="close sidebar" xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-x" width="24" height="24" viewBox="0 0 24 24" strokeWidth="1" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <ul className="f-m-m">
                    <li className="text-white pt-8">
                      <div className="flex items-center">
                        ...
                        <a href="javascript:void(0)" className="text-indigo-500 ml-3 text-lg">Dashboard</a>
                      </div>
                    </li>
                    <li className="text-gray-700 pt-8">
                      <div className="flex items-center">
                        <div className="flex items-center">
                          ...
                          <a href="javascript:void(0)" className="text-gray-700 ml-3 text-lg">Products</a>
                        </div>
                        <button id="chevronup" className="ml-4 focus:outline-none focus:ring-2 focus:ring-gray-500 rounded">
                          <svg aria-label="open products list" xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevron-down " width="14" height="14" viewBox="0 0 24 24" strokeWidth="1" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <polyline points="6 9 12 15 18 9" />
                          </svg>
                        </button>
                        <button id="chevrondown" className="hidden ml-4 focus:outline-none focus:ring-2 focus:ring-gray-500 rounded ">
                          <svg aria-label="close products list" xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevron-up" width="14" height="14" viewBox="0 0 24 24" strokeWidth="1" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                      ...
                      <div id="list" className="hidden">
                        <ul className="my-3">
                          <li className="text-sm text-indigo-500 py-2 px-6"><a href="javascript:void(0)"> Best Sellers </a></li>
                          <li className="text-sm text-gray-800 hover:text-indigo-500 py-2 px-6"><a href="javascript:void(0)"> Out of Stock</a></li>
                          <li className="text-sm text-gray-800 hover:text-indigo-500 py-2 px-6"><a href="javascript:void(0)"> New Products</a></li>
                        </ul>
                      </div>
                    </li>
                    <li className="text-gray-800 pt-8">
                      <div className="flex items-center">
                        ...
                        <a href="javascript:void(0)" className="text-gray-800 ml-3 text-lg">Performance</a>
                      </div>
                    </li>
                    <li className="text-gray-800 pt-8">
                      <div className="flex items-center">
                        <div className="flex items-center">
                          ...
                          <a href="javascript:void(0)" className="text-gray-800 ml-3 text-lg">Deliverables</a>
                        </div>
                        <div>
                          <button id="chevronup2" className="ml-4 focus:outline-none focus:ring-2 focus:ring-gray-500 rounded">
                            <svg aria-label="open deliverables list" xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevron-down" width="14" height="14" viewBox="0 0 24 24" strokeWidth="1" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                              <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                              <polyline points="6 9 12 15 18 9" />
                            </svg>
                          </button>
                          <button id="chevrondown2" className="hidden ml-4 focus:outline-none focus:ring-2 focus:ring-gray-500 rounded">
                            <svg aria-label="open deliverables list" xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevron-up" width="14" height="14" viewBox="0 0 24 24" strokeWidth="1" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                              <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                              <polyline points="6 15 12 9 18 15" />
                            </svg>
                          </button>
                ...
                <div className="w-full">
                  <div className="flex justify-center mb-4 w-full px-6">
                    <div className="relative w-full">
                      ...
                      <input className="bg-gray-100 focus:outline-none rounded w-full text-sm text-gray-500 placeholder-gray-600 bg-gray-100 pl-10 py-2" type="text" placeholder="Search" />
                    </div>
                  </div>
                      ...
                      <ul className="flex">
                        <li className="cursor-pointer text-white pt-5 pb-3">
                          <a href="javascript:void(0)">
                            <svg aria-label="open chats" xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-messages" width="24" height="24" viewBox="0 0 24 24" strokeWidth="1" stroke="#718096" fill="none" strokeLinecap="round" strokeLinejoin="round">
                              <path stroke="none" d="M0 0h24v24H0z"></path>
                        ...
                        <li className="cursor-pointer text-white pt-5 pb-3 pl-3">
                          <a href="javascript:void(0)">
                            <svg aria-label="open notifications" xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-bell" width="24" height="24" viewBox="0 0 24 24" strokeWidth="1" stroke="#718096" fill="none" strokeLinecap="round" strokeLinejoin="round">
                              <path stroke="none" d="M0 0h24v24H0z"></path>
            ...
            <div className="container px-6 justify-between h-16 flex items-center lg:items-stretch mx-auto">
              <div className="h-full flex items-center">
                <div aria-label="Home" role="img" className="mr-10 flex items-center">
                  <svg id="logo" enable-background="new 0 0 300 300" height="44" viewBox="0 0 300 300" width="43" xmlns="http://www.w3.org/2000/svg">
                    <g>
                      <path
                        fill="#4c51bf"
                ...
                <ul className="pr-12 xl:flex items-center h-full hidden">
                  <li className="hover:text-indigo-700 cursor-pointer h-full flex items-center text-sm text-indigo-700 tracking-normal border-b-2 border-indigo-700"><a href="javascript:void(0)"> Dashboard</a></li>
                  <li className="hover:text-indigo-700 cursor-pointer h-full flex items-center text-sm text-gry-800 mx-10 tracking-normal" ><a href="javascript:void(0)">Products</a></li>
                  <li className="hover:text-indigo-700 cursor-pointer h-full flex items-center text-sm text-gry-800 mr-10 tracking-normal"><a href="javascript:void(0)">Performance</a></li>
                  <li className="hover:text-indigo-700 cursor-pointer h-full flex items-center text-sm text-gray-800 tracking-normal"><a href="javascript:void(0)">Deliverables</a></li>
                </ul>
              </div>
                ...
                <div className="w-full h-full flex items-center">
                  <div className="w-full pr-12 h-full flex items-center border-r">
                    <div className="relative w-full">
                      ...
                      <input className="border border-gray-100 focus:outline-none focus:border-indigo-700 w-56 rounded text-sm text-gray-500 placeholder-gray-600 bg-gray-100 pl-8 py-2" type="text" placeholder="Search" />
                    </div>
                  </div>
                  <div className="w-full h-full flex">
                    ...
                    <div aria-haspopup="true" className="cursor-pointer w-full flex items-center justify-end relative">
                      <button aria-haspopup="true" className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 rounded flex items-center" >
                      ...
                      <ul className="p-2 w-40 border-r bg-white absolute rounded z-40 left-0 shadow mt-64 hidden">
                        <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                          <div className="flex items-center">
                            ...
                            <a href="javascript:void(0)" className="ml-2">My Profile</a>
                          </div>
                        </li>
                        <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex items-center">
                          ...
                          <a href="javascript:void(0)" className="ml-2">Help Center</a>
                        </li>
                        <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-indigo-700 flex items-center focus:text-indigo-700 focus:outline-none">
                          ...
                          <a href="javascript:void(0)" className="ml-2">Account Settings</a>
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              <div className="visible xl:hidden flex items-center">
                <div>
                  <button id="menu" className="text-gray-800 rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800">
                    <svg aria-label="open sidebar menu" xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-menu-2" width="24" height="24" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
          ...
          <div className="my-6 lg:my-12 container px-6 mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between pb-4 border-b border-gray-300">
            ...
            <div className="mt-6 lg:mt-0">
              <button className="mx-2 my-2 bg-white transition duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-700 focus:ring-white hover:bg-gray-100 rounded text-indigo-700 px-6 py-2 text-sm">Back</button>
              <button className="transition duration-150 ease-in-out hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 border bg-indigo-700 rounded text-white px-8 py-2 text-sm">Edit Profile</button>
            </div>
          </div>
